...
class DatetimeType extends Type {
	...
	public function getSearchInput() {
		...
		return '<div class="input-group"><span class="input-group-addon">from</span>'.$this->dateType_getInput(parent::getSearchName('beg'), $date_beg, false).
				'<span class="input-group-addon">till</span>'.$this->dateType_getInput(parent::getSearchName('end'), $date_end, false).
				'<span class="input-group-addon"><a href="javascript:void(0)" onClick="emptyDateSearch(\''.parent::getSearchName().'\')">Empty</a></span>
</div>';
	}
