...
class DateType extends Type {
	...
	public function getSearchInput() {
		...
		return '<div class="form-inline">from '.$this->dateType_getInput(parent::getSearchName('beg'), $date_beg, false).' till '.$this->dateType_getInput(parent::getSearchName('end'), $date_end, false).' <a href="javascript:void(0)" onClick="emptyDateSearch(\''.parent::getSearchName().'\')">Empty</a></div>';
	}
