...
<div class="btn-group pull-right">
  ...
  <ul class="dropdown-menu admin-dropdown-menu">
    <li><a href="'.$ref[0].'/'.$id.'/edit"><i class="glyphicon glyphicon-pencil"></i> Edit</a></li>
    <li><a href="javascript:startDelete('.$id.')"><i class="glyphicon glyphicon-trash"></i> Delete</a></li>
    <li><a href="javascript:showCopyDialog('.$id.')"><i class="glyphicon glyphicon-random"></i> Copy</a></li>
  </ul>
</div>
</td>
';
